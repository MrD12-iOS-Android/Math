...
public class Masalartoplami extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.masalalartoplami);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                   Intent intent = new Intent(Masalartoplami.this, Mavzular.class);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Masalartoplami.this, Masalalar.class);
                    startActivity(intent);finish();
                }catch (Exception e){
