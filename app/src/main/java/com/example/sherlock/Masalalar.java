...
public class Masalalar extends AppCompatActivity {
    ...
    @SuppressLint({"ClickableViewAccessibility", "ResourceType", "WrongViewCast", "CutPasteId"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.masalalar);
...
// Here Animation Start
        ...
        imageView_02 = findViewById(R.id.img_02);
        imageView.setAnimation(anim_imageView);
...
// Here Animation End
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.misol1);
        ...
        btn_back = findViewById(R.id.btn_back_end);
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Masalalar.this, Masalartoplami.class);
