...
public class Mavzu5masalalar01 extends AppCompatActivity {

    Animation anim_btn_Yechim,anim_imageView,anim_btn_back01,topa_title,anim_bt_play;
    ImageView imageView,imageView_02, btPlay,btPause,btn_back,btn_back01;
    Context context;
    MediaPlayer mediaPlayer;
    Handler handler = new Handler();
    Runnable runnable;
    TextView textView;
    Button mavzu_5_1_masala_2_img,btn_Yechim;


    @SuppressLint({"ClickableViewAccessibility", "CutPasteId", "WrongViewCast"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mavzu5masalalar01);
...
// Here Animation Start
        ...
        imageView = findViewById(R.id.mavzu_5_1_masala_1_img);
        imageView.setAnimation(anim_imageView);

        imageView_02 = findViewById(R.id.mavzu_5_1_masala_2_img);
...
// Here Animation End
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.dialog_4_mavzu_1_masala_2_img);
                dialog.show();
            }
        });
        ...
        btn_Yechim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imageView_02.setVisibility(View.VISIBLE);
            }
        });
        // Image Hidden End
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.misol2);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Mavzu5masalalar01.this, Mavzu5masalartoplami.class);
